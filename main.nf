...
Channel.value(params.mate).into{g_229_mate0_g_304;g_229_mate1_g256_26;g_229_mate1_g256_30;g_229_mate1_g256_46;g_229_mate1_g257_11;g_229_mate1_g257_16;g_229_mate1_g257_18;g_229_mate1_g257_19;g_229_mate1_g257_20;g_229_mate1_g257_21;g_229_mate1_g257_24;g_229_mate1_g257_23;g_229_mate0_g257_28;g_229_mate0_g257_31;g_229_mate0_g266_3;g_229_mate0_g271_36;g_229_mate0_g288_26;g_229_mate1_g293_82;g_229_mate1_g293_95;g_229_mate0_g293_131;g_229_mate1_g293_133}
if (params.reads){
Channel
...
Channel.value(params.run_FeatureCounts_after_Kallisto).set{g_276_run_featureCounts0_g273_125}
Channel.value(params.run_FeatureCounts_after_RSEM).set{g_294_run_featureCounts0_g293_125}
...
output:
 file "*/${gtf}" optional true  into g245_54_gtfFile01_g256_47, g245_54_gtfFile01_g266_2, g245_54_gtfFile03_g271_36, g245_54_gtfFile01_g271_38, g245_54_gtfFile01_g271_39, g245_54_gtfFile01_g271_32, g245_54_gtfFile03_g273_133, g245_54_gtfFile01_g288_31, g245_54_gtfFile03_g293_133
 file "*/${genome}" optional true  into g245_54_genome10_g256_47, g245_54_genome10_g266_2, g245_54_genome10_g271_32, g245_54_genome10_g288_31
 file "*/${genomeSizes}" optional true  into g245_54_genomeSizes22_g273_131, g245_54_genomeSizes21_g273_142, g245_54_genomeSizes24_g271_36, g245_54_genomeSizes22_g293_131, g245_54_genomeSizes21_g293_142
 file "*/${bed}" optional true  into g245_54_bed31_g273_134, g245_54_bed31_g293_134
...
input:
 val run_featureCounts from g_294_run_featureCounts0_g293_125

output:
 val run_params  into g293_125_run_parameters02_g293_133
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /${index}$/) "rsem_inde/$filename"}
input:
 file genome from g245_54_genome10_g288_31
 file gtf from g245_54_gtfFile01_g288_31

output:
 file "${index}"  into g288_31_rsemIndex00_g288_32
...
input:
 val run_featureCounts from g_276_run_featureCounts0_g273_125

output:
 val run_params  into g273_125_run_parameters02_g273_133
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /$index\/.*.idx$/) "kalisto/$filename"}
input:
 file genome from g245_54_genome10_g271_32
 file gtf from g245_54_gtfFile01_g271_32

output:
 file "$index/*.idx"  into g271_32_kallisto_index00_g271_31
...
g271_32_kallisto_index00_g271_31= g271_32_kallisto_index00_g271_31.ifEmpty([""]) 


if (!((params.run_Kallisto && (params.run_Kallisto == "yes")) || !params.run_Kallisto)){
g271_32_kallisto_index00_g271_31.set{g271_31_kallisto_index02_g271_36}
} else {

process Kallisto_module_check_kallisto_files {

input:
 file kallisto from g271_32_kallisto_index00_g271_31

output:
 file "*/${kallisto}" optional true  into g271_31_kallisto_index02_g271_36
...
build_hisat3n_index = params.SlamTools_Module_Check_Build_HISAT_3N_index.build_hisat3n_index


process SlamTools_Module_Check_Build_HISAT_3N_index {

input:
 file genome from g245_54_genome10_g266_2
 file gtf from g245_54_gtfFile01_g266_2

output:
 file "$index"  into g266_2_hisat3nindex00_g266_13

when:
build_hisat3n_index == true && ((params.run_SlamTools && (params.run_SlamTools == "yes")) || !params.run_SlamTools)

script:
HISAT3N_build_parameters = params.SlamTools_Module_Check_Build_HISAT_3N_index.HISAT3N_build_parameters
basename = genome.baseName
basenameGTF = gtf.baseName
index_dir = ""
if (params.hisat3n_index.indexOf('/') > -1){
	index_dir  = file(params.hisat3n_index).getParent()
}
index = "Hisat3nIndex" 
...
"""
count=`ls -1 ${index_dir}/*.ht21 2>/dev/null | wc -l`
if [ $count != 0 ] ; then
    mkdir -p $index && mv $genome $gtf $index/. && cd $index
    $extract_splice_sites
    $extract_exons
    /hisat-3n/hisat-3n-build ${HISAT3N_build_parameters} $ss $exon ${genome} genome
    cd ..
    if [ "${index_dir}" != "" ] ; then
		mkdir -p ${index_dir}
		cp -R -n $index  ${index_dir}
...
g266_2_hisat3nindex00_g266_13= g266_2_hisat3nindex00_g266_13.ifEmpty([""]) 


if (!(params.run_SlamTools == "yes")){
g266_2_hisat3nindex00_g266_13.set{g266_13_hisat3nindex02_g266_3}
} else {

process SlamTools_Module_check_hisat3n_files {

input:
 file hisat3n from g266_2_hisat3nindex00_g266_13

output:
 file "*/${hisat3n}" optional true  into g266_13_hisat3nindex02_g266_3

when:
params.run_SlamTools == "yes"

script:
(cmd, hisat3n) = pathChecker(hisat3n, params.hisat3n_index, "folder")
"""
$cmd
"""
}
...
//* autofill
if (!(params.run_Sequential_Mapping == "yes")){
g257_20_reads00_g256_46.set{g256_46_reads01_g_304}
...
output:
 set val(name), file("final_reads/*q")  into g256_46_reads01_g_304
...
g256_46_reads01_g_304.set{g_304_reads01_g266_3}
} else {
...
input:
 val mate from g_229_mate0_g_304
 set val(name), file(reads) from g256_46_reads01_g_304.map(flatPairsClosure).splitFastq(splitFastqParams).map(groupPairsClosure)

output:
 set val(name), file("split/*q")  into g_304_reads01_g266_3
...
process SlamTools_Module_HISAT_3N_mapper {

publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /${newName}.bam$/) "Hisat3N/$filename"}
input:
 val mate from g_229_mate0_g266_3
 set val(name), file(reads) from g_304_reads01_g266_3
 file hisat3nindex from g266_13_hisat3nindex02_g266_3

output:
 set val(name), file("${newName}.bam")  into g266_3_mapped_reads00_g266_15

when:
(params.run_SlamTools && (params.run_SlamTools == "yes")) || !params.run_SlamTools

script:
HISAT3_parameters = params.SlamTools_Module_HISAT_3N_mapper.HISAT3_parameters
nameAll = reads.toString()
nameArray = nameAll.split(' ')
file2 = ""
...
ln -s ${hisat3nindex}/* . 
if [ "${mate}" == "pair" ]; then
    /hisat-3n/hisat-3n -x genome -1 ${file1} -2 ${file2} ${HISAT3_parameters} | samtools view -bS -o ${newName}.bam
else
    /hisat-3n/hisat-3n -x genome -U ${file1} ${HISAT3_parameters} | samtools view -bS -o ${newName}.bam
fi
...
process SlamTools_Module_Merge_Bam {

input:
 set val(oldname), file(bamfiles) from g266_3_mapped_reads00_g266_15.groupTuple()

output:
 set val(oldname), file("${oldname}.bam")  into g266_15_merged_bams00_g266_7
 set val(oldname), file("*_sorted*bai")  into g266_15_bam_index11
 set val(oldname), file("*_sorted*bam")  into g266_15_sorted_bam22
...
//* params.SlamTools =  ""  //* @input
if (!((params.run_SlamTools && (params.run_SlamTools == "yes")) || !params.run_SlamTools)){
g266_15_merged_bams00_g266_7.into{g266_7_mapped_reads00;g266_7_mapped_reads22}
g266_7_reads10_g266_11 = Channel.empty()
} else {


process SlamTools_Module_SlamTools {

publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /conversion\/.*.bam$/) "converted_bam/$filename"}
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /${name}_sortedbyname.bam$/) "Hisat3N/$filename"}
input:
 set val(name),file(bam) from g266_15_merged_bams00_g266_7

output:
 set val(name),file("conversion/*.bam")  into g266_7_mapped_reads00
 set val(name1),file("conversion/*_unconverted*.fastq"),val(name2),file("conversion/*_converted*.fastq")  into g266_7_reads10_g266_11
 set val(name), file("${name}_sortedbyname.bam")  into g266_7_mapped_reads22
...
script:
namenew = bam.baseName
name1 = name+"_unconverted"
name2 = name+"_converted"

"""
samtools sort -o ${name}_sorted.bam ${bam} && samtools index ${name}_sorted.bam
samtools sort -n ${bam} -o ${name}_sortedbyname.bam
mkdir conversion
java -Xmx8g -Xms4g -jar ${params.SlamTools} -inputBam ${name}_sortedbyname.bam -p -r -outDir conversion
samtools fastq -n -1 conversion/${name}_sortedbyname_unconverted_R1.fastq -2 conversion/${name}_sortedbyname_unconverted_R2.fastq conversion/${name}_sortedbyname_unconverted.bam
samtools fastq -n -1 conversion/${name}_sortedbyname_converted_R1.fastq -2 conversion/${name}_sortedbyname_converted_R2.fastq conversion/${name}_sortedbyname_converted.bam 
"""
}
}


// Flat file structure first, and then build groups for converted and uncoverted
//.map(flatPairsClosure).map(groupPairsClosure)
...
groupPairsClosure = {row -> tuple(row[0], (row[2]) ? [file(row[1]), file(row[2])] : [file(row[1])])}
if (!((params.run_SlamTools && (params.run_SlamTools == "yes")) || !params.run_SlamTools)){
g266_7_reads10_g266_11.into{g266_11_fastq01_g271_36; g266_11_fastq01_g288_26}
} else {

process SlamTools_Module_Split_SlamTools_Conversion {

publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /split\/.*.fastq$/) "converted_fastq/$filename"}
input:
 set val(name), file(reads) from g266_7_reads10_g266_11.flatten().buffer(size:3).map{items -> tuple(items[0], tuple(items[1],items[2])) }

output:
 set val(name), file("split/*.fastq")  into g266_11_fastq01_g271_36, g266_11_fastq01_g288_26
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /kallisto_${name}$/) "kalisto/$filename"}
input:
 val mate from g_229_mate0_g271_36
 set val(name), file(reads) from g266_11_fastq01_g271_36
 file kallisto_index from g271_31_kallisto_index02_g271_36
 file gtf from g245_54_gtfFile03_g271_36
 file genome_sizes from g245_54_genomeSizes24_g271_36

output:
 file "kallisto_${name}"  into g271_36_outputDir00_g271_22, g271_36_outputDir00_g271_38, g271_36_outputDir013_g_177
 set val(name), file("*.bam") optional true  into g271_36_bam_file10_g273_121, g271_36_bam_file11_g273_131, g271_36_bam_file10_g273_133, g271_36_bam_file10_g273_134, g271_36_bam_file10_g273_142
 file "*.bam.bai" optional true  into g271_36_bam_bai22
...
input:
 set val(name), file(bam) from g271_36_bam_file10_g273_142
 file genomeSizes from g245_54_genomeSizes21_g273_142

output:
 file "*.bw"  into g273_142_outputFileBw00
...
input:
 set val(name), file(bam) from g271_36_bam_file10_g273_134
 file bed from g245_54_bed31_g273_134

output:
 file "result/*.out"  into g273_134_outputFileOut00_g273_95, g273_134_outputFileOut014_g_177
...
input:
 file rseqcOut from g273_134_outputFileOut00_g273_95.collect()

output:
 file "*.tsv"  into g273_95_outputFileTSV00
...
input:
 set val(name), file(bam) from g271_36_bam_file10_g273_133
 each run_params from g273_125_run_parameters02_g273_133
 file gtf from g245_54_gtfFile03_g273_133

output:
 file "*"  into g273_133_outputFileTSV00_g273_117
...
input:
 file featureCountsOut from g273_133_outputFileTSV00_g273_117.collect()

output:
 file "*_featureCounts.tsv"  into g273_117_outputFile00
 file "*_featureCounts.sum.tsv"  into g273_117_outFileTSV11
...
input:
 set val(name), file(bam) from g271_36_bam_file11_g273_131
 file genomeSizes from g245_54_genomeSizes22_g273_131

output:
 file "*.tdf"  into g273_131_outputFileOut00
...
input:
 set val(name), file(bam) from g271_36_bam_file10_g273_121

output:
 file "*_metrics"  into g273_121_outputFileOut00_g273_82
 file "results/*.pdf"  into g273_121_outputFilePdf12_g273_82
...
input:
 file picardOut from g273_121_outputFileOut00_g273_82.collect()
 file picardPdf from g273_121_outputFilePdf12_g273_82.collect()

output:
 file "*.tsv"  into g273_82_outputFileTSV00
 file "results/*.pdf"  into g273_82_outputFilePdf11
...
input:
 file outDir from g271_36_outputDir00_g271_38
 file gtf from g245_54_gtfFile01_g271_38

output:
 file newoutDir  into g271_38_outputDir00_g271_39
...
publishDir params.outdir, mode: 'copy', saveAs: {filename -> if (filename =~ /.*.tsv$/) "kalisto/$filename"}
input:
 file kallistoOut from g271_38_outputDir00_g271_39.collect()
 file gtf from g245_54_gtfFile01_g271_39

output:
 file "*.tsv"  into g271_39_outputFile00
...
input:
 file kallistoDir from g271_36_outputDir00_g271_22.collect()

output:
 file "kallisto_alignment_sum.tsv"  into g271_22_outFileTSV010_g_198
...
g288_31_rsemIndex00_g288_32= g288_31_rsemIndex00_g288_32.ifEmpty([""]) 


if (!((params.run_RSEM && (params.run_RSEM == "yes")) || !params.run_RSEM)){
g288_31_rsemIndex00_g288_32.set{g288_32_rsemIndex02_g288_26}
} else {

process RSEM_module_check_RSEM_files {

input:
 file rsem from g288_31_rsemIndex00_g288_32

output:
 file "*/${rsem}" optional true  into g288_32_rsemIndex02_g288_26
...
input:
 val mate from g_229_mate0_g288_26
 set val(name), file(reads) from g266_11_fastq01_g288_26
 file rsemIndex from g288_32_rsemIndex02_g288_26

output:
 file "pipe.rsem.${name}"  into g288_26_rsemOut00_g288_17, g288_26_rsemOut00_g288_21, g288_26_rsemOut01_g_177
 set val(name), file("pipe.rsem.*/*.genome.bam") optional true  into g288_26_bam_file11
 set val(name), file("pipe.rsem.*/*.bam") optional true  into g288_26_mapped_reads22
 file "pipe.rsem.*/*.genome.bam" optional true  into g288_26_genome_bam30_g288_23
...
input:
 file bam from g288_26_genome_bam30_g288_23.flatten()

output:
 set val(name),file(bam)  into g288_23_bam_file00_g293_121, g288_23_bam_file01_g293_131, g288_23_bam_file00_g293_133, g288_23_bam_file00_g293_134, g288_23_bam_file00_g293_142
...
input:
 set val(name), file(bam) from g288_23_bam_file00_g293_142
 file genomeSizes from g245_54_genomeSizes21_g293_142

output:
 file "*.bw"  into g293_142_outputFileBw00
...
input:
 set val(name), file(bam) from g288_23_bam_file00_g293_134
 file bed from g245_54_bed31_g293_134

output:
 file "result/*.out"  into g293_134_outputFileOut00_g293_95, g293_134_outputFileOut07_g_177
...
input:
 file "rsem/*" from g288_26_rsemOut01_g_177.flatten().toList()
 ...
 file "rseqc_rsem/*" from g293_134_outputFileOut07_g_177.flatten().toList()
 file "kallisto/*" from g271_36_outputDir013_g_177.flatten().toList()
 file "rseqc_kallisto/*" from g273_134_outputFileOut014_g_177.flatten().toList()
...
input:
 file rseqcOut from g293_134_outputFileOut00_g293_95.collect()
 val mate from g_229_mate1_g293_95

output:
 file "*.tsv"  into g293_95_outputFileTSV00
...
input:
 set val(name), file(bam) from g288_23_bam_file00_g293_133
 val paired from g_229_mate1_g293_133
 each run_params from g293_125_run_parameters02_g293_133
 file gtf from g245_54_gtfFile03_g293_133

output:
 file "*"  into g293_133_outputFileTSV00_g293_117
...
input:
 file featureCountsOut from g293_133_outputFileTSV00_g293_117.collect()

output:
 file "*_featureCounts.tsv"  into g293_117_outputFile00
 file "*_featureCounts.sum.tsv"  into g293_117_outFileTSV11
...
input:
 val mate from g_229_mate0_g293_131
 set val(name), file(bam) from g288_23_bam_file01_g293_131
 file genomeSizes from g245_54_genomeSizes22_g293_131

output:
 file "*.tdf"  into g293_131_outputFileOut00
...
input:
 set val(name), file(bam) from g288_23_bam_file00_g293_121

output:
 file "*_metrics"  into g293_121_outputFileOut00_g293_82
 file "results/*.pdf"  into g293_121_outputFilePdf12_g293_82
...
input:
 file picardOut from g293_121_outputFileOut00_g293_82.collect()
 val mate from g_229_mate1_g293_82
 file picardPdf from g293_121_outputFilePdf12_g293_82.collect()

output:
 file "*.tsv"  into g293_82_outputFileTSV00
 file "results/*.pdf"  into g293_82_outputFilePdf11
...
input:
 file rsemDir from g288_26_rsemOut00_g288_17.collect()

output:
 file "rsem_alignment_sum.tsv"  into g288_17_outputFileTSV03_g_198
...
g288_17_outputFileTSV03_g_198= g288_17_outputFileTSV03_g_198.ifEmpty([""]) 
...
g271_22_outFileTSV010_g_198= g271_22_outFileTSV010_g_198.ifEmpty([""]) 
...
input:
 ...
 file rsemSum from g288_17_outputFileTSV03_g_198
 ...
 file traxSum from g271_22_outFileTSV010_g_198
...
input:
 file rsemOut from g288_26_rsemOut00_g288_21.collect()

output:
 file "*.tsv"  into g288_21_outputFile00
 val wdir  into g288_21_wdir10_g288_14
...
input:
 val wdir from g288_21_wdir10_g288_14

output:
 file "*.rmd" optional true  into g288_14_rMarkdown00
